                  ...
                  <div class="col-sm-12">
                     <div class="custom_menu">
                        <ul>
                           ...
                           <li><a href="{{route('custom.service')}}">Customer Service</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
               ...
               <div class="containt_main">
                  <div id="mySidenav" class="sidenav">
                    ...
                    @foreach($categories as $category)
                            <a href="{{route('category.index', [$category->id, $category->slug])}}">{{$category->category_name}}</a>
                    @endforeach
                  ...
                  <div class="dropdown">
                     ...
                     <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        @foreach($categories as $category)
                        <a class="dropdown-item" href="fashion.html">{{$category->category_name}}</a>
                @endforeach
